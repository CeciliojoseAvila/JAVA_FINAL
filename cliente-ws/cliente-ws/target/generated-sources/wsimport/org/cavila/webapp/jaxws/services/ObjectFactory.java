 ...
 * generated in the org.cavila.webapp.jaxws.services package. 
...
public class ObjectFactory {
    ...
    private final static QName _Crear_QNAME = new QName("http://services.jaxws.webapp.cavila.org/", "crear");
    private final static QName _CrearResponse_QNAME = new QName("http://services.jaxws.webapp.cavila.org/", "crearResponse");
    private final static QName _Listar_QNAME = new QName("http://services.jaxws.webapp.cavila.org/", "listar");
    private final static QName _ListarResponse_QNAME = new QName("http://services.jaxws.webapp.cavila.org/", "listarResponse");
    private final static QName _Saludar_QNAME = new QName("http://services.jaxws.webapp.cavila.org/", "saludar");
    private final static QName _SaludarResponse_QNAME = new QName("http://services.jaxws.webapp.cavila.org/", "saludarResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: org.cavila.webapp.jaxws.services
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "http://services.jaxws.webapp.cavila.org/", name = "crear")
     ...
     */
    @XmlElementDecl(namespace = "http://services.jaxws.webapp.cavila.org/", name = "crearResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://services.jaxws.webapp.cavila.org/", name = "listar")
     ...
     */
    @XmlElementDecl(namespace = "http://services.jaxws.webapp.cavila.org/", name = "listarResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://services.jaxws.webapp.cavila.org/", name = "saludar")
     ...
     */
    @XmlElementDecl(namespace = "http://services.jaxws.webapp.cavila.org/", name = "saludarResponse")
